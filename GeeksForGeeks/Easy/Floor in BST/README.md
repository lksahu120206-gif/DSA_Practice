...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/closest-neighbor-in-bst/1)

## Solved On
12 Jul 2026 at 10:30 am

<h2><a href="https://www.geeksforgeeks.org/problems/closest-neighbor-in-bst/1">Floor in BST</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given the <strong>root</strong> of a<strong> <a title="BST" href="https://www.geeksforgeeks.org/binary-search-tree-data-structure/" target="_blank" rel="noopener">binary search tree</a></strong> and a number <strong>k</strong>, find the <strong>greatest</strong> number in the binary search tree that is less than or equal to <strong>k</strong>.</span></p>
<p><span style="font-size: 14pt;"><strong>Note:</strong> If no such node value exists that is smaller than <em data-start="198" data-end="201">k</em>, then return<strong> -1</strong>.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ number of nodes ≤ 10<sup>5<br></sup>1 ≤ node-&gt;data, k ≤ 10<sup>5<br></sup>All nodes are unique in the BST</span></p>