...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/rod-cutting0840/1)

## Solved On
27 Jul 2026 at 04:48 pm

<h2><a href="https://www.geeksforgeeks.org/problems/rod-cutting0840/1">Rod Cutting</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Given a rod of length <strong>n </strong>inches and an array <strong>price[]</strong>, where price[i] denotes the value of a piece of length i <strong>(1-based Index)</strong>. Determine the maximum value obtainable by cutting up the rod and selling the pieces.</span></p>
