...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/implementing-ceil-in-bst/1)

## Solved On
12 Jul 2026 at 10:30 am

<h2><a href="https://www.geeksforgeeks.org/problems/implementing-ceil-in-bst/1">Ceil in BST</a></h2><h3>Difficulty Level: Medium</h3><hr><p data-pm-slice="0 0 []"><span style="font-size: 14pt;">Given a <strong>root</strong>&nbsp;binary search tree and an integer&nbsp;<strong>x </strong>, find the Ceil of&nbsp;<strong>x</strong> in the tree.</span></p>
<p data-pm-slice="0 0 []"><span style="font-size: 14pt;"><strong>Ceil(x)</strong> is a number that is either equal to x or is immediately greater than x. If Ceil could not be found, return <strong>-1</strong>.</span></p>
