...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/find-the-string-in-grid0111/1)

## Solved On
08 Sept 2026 at 11:42 pm

<h2><a href="https://www.geeksforgeeks.org/problems/find-the-string-in-grid0111/1">Word in Grid - All Occurrences</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given a 2D grid <strong>mat[][]</strong> of size<strong> n × m</strong> consisting of characters and a string <strong>word</strong>, find all starting positions where the word occurs in the grid. </span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 &lt;= n &lt;= m &lt;= 50<br>1 &lt;= |word| &lt;= 20</span></p>